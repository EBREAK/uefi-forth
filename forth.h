...
enum {
    // CORE WORDS
	O_NOOP, O_HALT, O_BRANCH, O_ZBRANCH,
	O_EXIT, O_CALL, O_LIT, O_DOCONST, O_EXECUTE,
	O_PZCHK, O_EQCHK, O_DBGOFF, O_DBGON,
	O_DROP, O_DUP, O_SWAP, O_NIP, O_OVER,
	O_TOR, O_FROMR, O_PICK, O_DEPTH,
	O_PLUS, O_MINUS, O_1PLUS, O_1MINUS,
	O_MULTI, O_2MULTI, O_DIVID, O_2DIVID,
	O_LSHIFT, O_RSHIFT, O_AND, O_OR, O_XOR,
	O_INVERT, O_NEGATE, O_MOD,
	O_EQ, O_NE, O_EQZ, O_NEZ, O_LT, O_GT, O_ULT, O_UGT,
	O_DP, O_UPLOAD, O_STALOAD,
	O_CLOAD, O_WLOAD, O_LLOAD, O_XLOAD,
	O_CSTORE, O_WSTORE, O_LSTORE, O_XSTORE,
	O_PSP_RST, O_EARLY_ECHO_OFF, O_EARLY_ECHO_ON,

	// IO WORDS
	O_EARLY_WEMIT, O_EARLY_WKEY,
	O_USER_WEMIT, O_USER_WKEY,
	O_USER_DOT,

	// INTERPRET WORDS
	O_FIND, O_COMPOFF, O_COMPON, O_COMPSTA,
	O_ISIMMEDIATE, O_WIB, O_WIN,
	O_ISNUMBER, O_TONUMBER, O_WORD_NEW,
	O_XT2WNAME, O_XT2WNLEN, O_XT2PREV,
};
