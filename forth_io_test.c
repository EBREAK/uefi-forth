...
void forth_test_io(void) {
    ...
    // NUM4BIT>WHEX
    COMPILE(L"$0", L"NUM4BIT>WHEX"); LIT(L'0'); COMPILE(L"=CHK");
    COMPILE(L"$1", L"NUM4BIT>WHEX"); LIT(L'1'); COMPILE(L"=CHK");
    COMPILE(L"$8", L"NUM4BIT>WHEX"); LIT(L'8'); COMPILE(L"=CHK");
    COMPILE(L"$9", L"NUM4BIT>WHEX"); LIT(L'9'); COMPILE(L"=CHK");
    COMPILE(L"$A", L"NUM4BIT>WHEX"); LIT(L'A'); COMPILE(L"=CHK");
    COMPILE(L"$B", L"NUM4BIT>WHEX"); LIT(L'B'); COMPILE(L"=CHK");
    COMPILE(L"$E", L"NUM4BIT>WHEX"); LIT(L'E'); COMPILE(L"=CHK");
    COMPILE(L"$F", L"NUM4BIT>WHEX"); LIT(L'F'); COMPILE(L"=CHK", L"PZCHK");
